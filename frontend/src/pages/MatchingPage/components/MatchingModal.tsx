                                            ...
                                            <div className="relative pb-8">
                                                ...
                                                <div className="relative flex space-x-3">
                                                    <div>
                                                        <span
                                                            className={classNames(
                                                                connectionLoading ? 'bg-gray-400' : connectionSuccess ? 'bg-green-500' : 'bg-red-500',
                                                    ...
                                                    <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                        <div>
                                                            <p className="text-sm text-gray-500">
                                                                {connectionLoading ? "Establishing Connection..." : "Connection Established"}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="relative pb-8">
                                                <div className="relative flex space-x-3">
                                                    <div>
                                                        <span
                                                            className={classNames(
                                                                matchLoading ? 'bg-gray-400' : matchSuccess ? 'bg-green-500' : 'bg-red-500',
                                                                'h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white'
                                                            )}
                                                        >
                                                            {
                                                    ...
                                                    <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                        <div>
                                                            <p className="text-sm text-gray-500">
                                                                {matchLoading ? "Finding Match..." : matchSuccess ? "Match Found!" : "No Match Found!"}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
